                  ...
                  child: RichText(
                    text: const TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              "Pixel Conquest est un jeu multijoueur de conquête de territoires où la stratégie est la clé de la victoire. "
                              "Agrandissez votre territoire, générez des unités et affrontez les autres joueurs dans un combat sans merci. "
                              "Soyez le dernier joueur en vie pour gagner la partie. ",
                        ),
                        TextSpan(text: "\n\n\n"),
                        TextSpan(
                          text: "Solde\n",
